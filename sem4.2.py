...
FPS = 30
screen1, screen2, screen3, screen4 = (pygame.Surface((400, 600)),
                                      pygame.Surface((400, 600),pygame.SRCALPHA),
                                      pygame.Surface((400, 600),pygame.SRCALPHA),
                                      pygame.Surface((400, 600),pygame.SRCALPHA))
out = pygame.display.set_mode((800,600))
...
def pbear(screen):
    ...
    ellipse(screen, (0,0,0),(70,215,100,45),width=2)
    ...
    pygame.draw.arc(screen, (0,0,0),[80,215,15,10],-3.14/3,3.14*4/3,width=2)
        
    ellipse(screen, (240,240,240), (10,250,140,230)) #body
    ellipse(screen, (0,0,0), (10,250,140,230),width=2)
    ...
    line(screen,(0,0,0), (330,140),(325,460),width=2)

    ellipse(screen, (240,240,240),(120,320,60,25)) #arm
    ellipse(screen, (0,0,0),(120,320,60,25),width=2)
    
    ellipse(screen, (240,240,240),(90,430,100,70)) #leg1
    ellipse(screen, (0,0,0),(90,430,100,70),width =2)
    
    ellipse(screen, (240,240,240),(150,480,60,30)) #leg2
    ellipse(screen, (0,0,0),(150,480,60,30),width=2)

    ellipse(screen, (90,90,90), (220,425,150,50)) #target
    ellipse(screen, (0,0,0), (220,425,150,50),width=2)
    ellipse(screen, (0,102,102), (235,440,125,35))
    ellipse(screen, (0,0,0), (235,440,125,35),width=2)
...
backyard(screen1)
sun(screen1)
landscape = pygame.transform.scale(screen1,(800,600))
out.blit(landscape,(0,0))

pbear(screen2)
fish(screen2)

oneof = pygame.transform.scale(screen2,(267,400))
secondof= pygame.transform.flip(screen2,1,0)
thirdof=pygame.transform.scale(pygame.transform.flip(screen2, 1, 0),(267,400))

out.blit(oneof,(100,200))
out.blit(thirdof,(400,100))
out.blit(secondof,(400,70))

#save(out, 'uhhm_us.png')
